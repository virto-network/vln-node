...
impl<T: frame_system::Config> pallet_communities_manager::WeightInfo for WeightInfo<T> {
	...
	fn register() -> Weight {
		...
		//  Measured:  `316`
		//  Estimated: `132561`
		// Minimum execution time: 209_662_000 picoseconds.
		Weight::from_parts(232_840_000, 0)
	...
	fn create_memberships(q: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `368`
		//  Estimated: `3547 + q * (5904 ±0)`
		// Minimum execution time: 253_216_000 picoseconds.
		Weight::from_parts(145_162_991_820, 0)
			.saturating_add(Weight::from_parts(0, 3547))
			// Standard Error: 14_973_566
			.saturating_add(Weight::from_parts(203_648_192, 0).saturating_mul(q.into()))
	...
	fn set_gas_tank() -> Weight {
		...
		Weight::from_parts(108_204_000, 0)
